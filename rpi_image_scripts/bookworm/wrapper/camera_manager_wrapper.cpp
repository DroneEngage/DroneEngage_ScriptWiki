...
int main(int argc, char* argv[]) {
    ...
    while ((opt = getopt_long(argc, argv, "ctad", long_options, nullptr)) != -1) {
        switch (opt) {
            ...
            default:
                ...
                std::cerr << "Example: " << argv[0] << " --enable-local-cam-capture --enable-ai-tracker 1 \"/usr/share/rpi-camera-assets/imx500_mobilenet_ssd.json\"" << std::endl;
                return 1;
        }
    }
    ...
    // Step 2: Load v4l2loopback module if camera capture is enabled
