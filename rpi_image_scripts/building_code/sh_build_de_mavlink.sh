...
PROJECT_ROOT_DIR="$HOME/de_code/droneengage_mavlink"
DEPLOYMENT_TARGET_DIR="$HOME/drone_engage_binary/de_mavlink"
...
# Allow 'file' protocol just for this submodule update (needed for src/de_common)
...
"$DEPLOYMENT_TARGET_DIR"/de_ardupilot -v
