...
PROJECT_ROOT_DIR="$HOME/de_code/droneengage_communication"
DEPLOYMENT_TARGET_DIR="$HOME/drone_engage_binary/de_comm"
...
# Copy all executables/libraries and subdirectories (e.g., scripts) from the bin folder to the target directory
cp -r "$PROJECT_ROOT_DIR"/bin/* "$DEPLOYMENT_TARGET_DIR/"

# Return to the original directory
popd

"$DEPLOYMENT_TARGET_DIR"/de_comm -v
